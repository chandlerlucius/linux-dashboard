...
public final class Http2Server {
    ...
    public static void main(final String[] args) {
        ...
        wsDeploymentInfo.setBuffers(new DefaultByteBufferPool(true, 100));
        ...
        deploymentInfo.setResourceManager(new ClassPathResourceManager(classLoader, "com/utils/dashboard/"));
